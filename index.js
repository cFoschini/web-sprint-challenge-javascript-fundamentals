...
// nestedFunction can access the variable internal because 
//its in nestedFunction lexical environment and completes its closure.;
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(a){
    return a.map(i => i.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(a){
    return a.filter(i => i.population < 5);
  }
  ...
  */
  ...
  function USApop(a){
    return a.reduce((accum, pop) => accum + pop.population, 0);
  }
